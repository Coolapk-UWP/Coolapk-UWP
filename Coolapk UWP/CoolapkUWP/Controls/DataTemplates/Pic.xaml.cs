...
namespace CoolapkUWP.Controls.DataTemplates
{
    public partial class Pic : ResourceDictionary
    {
        ...
        public static void Image_Tapped(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            UIHelper.ShowImage((sender as FrameworkElement).Tag as Models.ImageModel);
        }

        public static void ListViewItem_KeyDown(object sender, Windows.UI.Xaml.Input.KeyRoutedEventArgs e)
        {
